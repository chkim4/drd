...
<!--                                 </a> -->
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h1 mt-4 mb-4 text-gray-800" style="font-weight: 800;">계정관리</h1>
					...
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<div class="card shadow mb-4">
								<div class="card-header py-3 font-weight-bold text-primary">회원정보 수정</div>
								<div class="card-body">
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<input type="date" class="form-control form-control-user"
														id="birth" name="birth" value="${member.birth}" readonly="readonly">
												</div>
											</div>
										</div>
										<div class="form-group">
					...
					<div class="col-lg-6">
						...
						<!-- Custom Text Color Utilities -->
						<div class="card shadow mb-4">
							<div class="card-header py-3 font-weight-bold text-primary">비밀번호 변경</div>
							<div class="card-body">
						...
						<form class="deleteuser" action="/mypage/deleteUser" method="post"
							...
							<div style="text-align: center;">
										<button type="button" class="btn" style="float: right; font-size: 12px;"
											id="deleteBTN">탈퇴하기</button>
									</div>
						</form>
					</div>
				</div>
