...
<head>
   ...
   <!-- 템플릿 관련 -->
	...
	$(document).ready(function() {
		$("#from_calender_date").append("<h4>${fromCalenderDate}</h4>")
		$("#from_recordtime").append("<h4>${fromRecordTime}</h4>")
		date = "${date}"
		console.log(date);
		$("#submit").on("click",function(){
			...
			success:function(data){
				...
				for (var i = 0; i < data.length; i++) {
					mydata = mydata+
					"<a href='/test3?date=${param.date}&exerciseseq="+data[i].exerciseSEQ+"'>"+data[i].name+"</a><br/>"
				}
			$("#from_exercise").empty();
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">활동</h1>
				...
				<hr/>
				<div id="from_exercise">
				</div>
				<hr/>
				<div id="from_record">
				<h3>${param.date}</h3>
				<br/>
				<c:forEach var="data" items="${fromRecordExerciselist }">
					${data.name}: ${data.muscleGroup},${data.equipment},${data.pushpull}&emsp;
					<button type="button" onclick="location.href='/test2?date=${param.date}&exerciseseq=${data.exerciseSEQ }'">삭제</button><br/>
				</c:forEach>
				</div>
            </div>
            <!-- End of Main Content -->
